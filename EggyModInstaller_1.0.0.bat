...
title Eggy Mod Installer 1.0.0
...
if exist "%APPDATA%\.minecraft\Mods\MorePies-*.jar" (echo Old versions found. Deleting... && del "%APPDATA%\.minecraft\Mods\MorePies-*.jar")
...
:MOREDIRTMOD
echo Checking for old versions...
if exist "%APPDATA%\.minecraft\Mods\MoreDirtMod-*.jar" (echo Old versions found. Deleting... && del "%APPDATA%\.minecraft\Mods\MoreDirtMod-*.jar")
